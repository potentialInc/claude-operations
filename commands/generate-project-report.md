...
allowed-tools: Agent, Read, Write, Edit, Glob, Grep, Bash(mkdir *, git clone *, git remote *, ls *), AskUserQuestion
---
...
All references located under `commands/references/generate-project-report/`:
...
| File | Purpose |
|------|---------|
| `commands/references/generate-project-report/report-template.md` | Korean report output template (10 sections) |
| `commands/references/generate-project-report/analysis-prompts.md` | Agent prompt specs, framework detection, scan patterns |
