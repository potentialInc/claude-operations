...
- [ ] store-prep/listing-google-play.md (listing text)
- [ ] store-prep/listing-app-store.md (listing text)
- [ ] store-prep/privacy-policy.md (privacy policy)
- [ ] store-prep/terms-of-service.md (terms of service)
...
2. Click "Create app"
3. Input fields (copy from `store-prep/listing-google-play.md`):
   - App name
...
4. Write release notes (Korean) — generate and present the following draft based on app analysis:
   ...
   **Draft generation rules:**
   - Summarize 3-5 core features from `store-prep/app-info.md`
...
| | SKU | Unique identifier |
| | Primary Language | Korean |
| | Category | Refer to `store-prep/listing-app-store.md` |
...
##### App Description (copy from `store-prep/listing-app-store.md`)
