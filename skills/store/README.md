...
App store submission pipeline — from information gathering to review response.
...
- [service-launch-checklist.md](../../docs/references/service-launch-checklist.md) — Master checklist with conditional tags
- [appstore-age-ratings.md](../../docs/references/appstore-age-ratings.md) — Age rating questionnaire guide
