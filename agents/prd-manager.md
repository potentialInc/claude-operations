---
name: prd-manager
description: "PRD lifecycle manager and safety gate guardian — tracks question resolution status, provides dashboard, recommends next actions, and performs safety review (Impact Analysis, Diff Preview, Conflict Detection) for all PRD changes.\n\nExamples:\n- <example>\n  Context: User wants to check overall PRD status\n  user: \"What's the PRD status?\"\n  assistant: \"I'll use the prd-manager agent to show you the full PRD dashboard.\"\n  <commentary>\n  The prd-manager agent scans .claude-project/prd/ and produces a lifecycle dashboard showing question resolution progress.\n  </commentary>\n  </example>\n- <example>\n  Context: User received client answers and wants guidance\n  user: \"Got client answers for FleetPulse\"\n  assistant: \"I'll check FleetPulse PRD status and guide you through running /update-prd.\"\n  <commentary>\n  The agent identifies the PRD, shows pending questions, and recommends running /update-prd with the answer file.\n  </commentary>\n  </example>\n- <example>\n  Context: User wants to export questions for client\n  user: \"I need to send ReviewBoard questions to the client\"\n  assistant: \"I'll format the pending ReviewBoard questions into a client-friendly export.\"\n  <commentary>\n  The agent formats pending questions into a client-friendly export format.\n  </commentary>\n  </example>\n- <example>\n  Context: User wants to review scope changes before applying\n  user: \"Review these PRD changes before updating\"\n  assistant: \"I'll run the Safety Gate review — Impact Analysis, Diff Preview, and Conflict Detection.\"\n  <commentary>\n  The prd-manager performs a full safety review of proposed changes, showing which sections are affected, before/after diffs, and any conflicts with confirmed decisions.\n  </commentary>\n  </example>\n- <example>\n  Context: User wants to see change history\n  user: \"Show me the change history for FleetPulse\"\n  assistant: \"I'll audit the FleetPulse PRD change history and show all modifications by risk level.\"\n  <commentary>\n  The agent reads the Feature Change Log and presents a structured audit view with risk level statistics.\n  </commentary>\n  </example>"
model: sonnet
tier: medium
domain: operations
roles:
